...
注意：
- document_id 和 file_token 通常是同一个值。用户可能提供文档链接，从中提取 token。
- 根据链接路径判断 file_type：/docx/XXX → file_type="docx"，/wiki/XXX → file_type="wiki"，/doc/XXX → file_type="doc"
- 示例：https://xxx.feishu.cn/wiki/ABC123 → file_token="ABC123", file_type="wiki"
